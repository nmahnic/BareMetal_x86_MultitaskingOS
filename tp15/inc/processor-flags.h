...
%define WAITING       0x00000001;
%define RUNNING        0x00000002;

; Revisar que va en cada caso..
%define PAG_RW_R_US_SUP 0b00000001;
%define PAG_RW_R_US_USR 0b00000101;
%define PAG_RW_W_US_SUP 0b00000011;
%define PAG_RW_W_US_USR 0b00000111;