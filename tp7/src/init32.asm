...
start32_launcher:
 ...
 ; --> Desempaquetamiento de la ROM (handlers) <--
    push ebp
    mov ebp, esp    ;enter
    push __handlers_32_size
    push __HANDLERS_32_VMA
    push __HANDLERS_32_LMA
    call __fast_memcopy
    leave
...
;// Inicializaci�n PIC N�1
 ...
 ;//Antes de inicializar el PIC N�2, deshabilitamos las Interrupciones del PIC1
  mov     al,0xFF	;(0x11111111)  antes decia --> mov al,0xFD	(0x11111101) no se porque dejaba el teclado
  out     0x21,al
