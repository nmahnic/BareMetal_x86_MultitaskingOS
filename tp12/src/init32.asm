...
;xchg bx,bx
 ...
 ;----------------------------------------------------------------------------------------
    mov edi, __DTP
    mov ecx, 5*0x400             ; Limpio 16K (4 paginas) que usaré
    xor eax,eax                  ; 1 para DTP y 4 para TPs
...
;xchg bx,bx
 ...
 ;------- 2da Pagina de la RAM (VIDEO_lineal = 0x0001 0000 -> VIDEO = 0x000B 8000) ------
    ; Contenido de DTP
    mov eax, __TP3                  ; Esta tabla está en __DTP + 0x3000 (tabla num 3)
 ...
 ;------- 3ra Pagina de la RAM (SYSTABLES = 0x0010 0000 identity mapping) ------
    ; Contenido de DTP
    mov eax, __TP3                    ; Esta tabla está en __DTP + 0x3000 (tabla num 3)
 ...
 ;------- 8va Pagina de la RAM (KENEL_lineas = 0x0120 0000 -> KERNEL = 0x0020 0000) ------
    ; Contenido de DTP
    mov eax, __TP4                    ; Esta tabla está en __DTP + 0x4000 (tabla num 4)
    add eax, 0x3                     ; ATTR de la TP
    ; Apunto al DTPE y le cargo su contenido
    mov dword [__DTP + 0x004*4], eax 
    ; Apunto a PTE y le cargo su contenido
 ...
 ;------- 9na Pagina de la RAM (Datos_lineal = 0x0120 2000 -> DATOS = 0x0020 2000) ------
    ; Contenido de DTP
    mov eax, __TP4                    ; Esta tabla está en __DTP + 0x4000 (tabla num 4)
    add eax, 0x3                     ; ATTR de la TP
    ; Apunto al DTPE y le cargo su contenido
 ...
 ;------- 10ma Pagina de la RAM (BSS gral = 0x0120 3000) ------
    ; Contenido de DTP
    mov eax, __TP4                    ; Esta tabla está en __DTP + 0x4000 (tabla num 4)
    add eax, 0x3                     ; ATTR de la TP
    ; Apunto al DTPE y le cargo su contenido
 ...
 ;------- 11ma Pagina de la RAM (Dig_lineal = 0x0121 0000 -> Digitos = 0x0021 0000) ------
    ; Contenido de DTP
    mov eax, __TP4                   ; Esta tabla está en __DTP + 0x4000 (tabla num 4)
    add eax, 0x3                     ; ATTR de la TP
    ; Apunto al DTPE y le cargo su contenido
 ...
 ;------- 11va a 13va Tarea 1 (Tarea1_lineal = 0x0130 0000 -> Tarea1 = 0x0030 0000) ------
    ; Contenido de DTP
    mov eax, __TP4                    ; Esta tabla está en __DTP + 0x4000 (tabla num 4)
    add eax, 0x3                     ; ATTR de la TP
    ; Apunto al DTPE y le cargo su contenido
