...
__attribute__(( section(".functions"))) void __set_dir_page_table_entry(dword init_dpt,
                                                                    dword entry,
                                                                    dword init_pt, 
                                                                    dword _ps,
                                                                    dword _a,
...
__attribute__(( section(".functions"))) void __set_page_table_entry(dword init_pt,
                                                                dword entry,
                                                                dword init_p, 
                                                                dword _ps,
                                                                dword _a,
