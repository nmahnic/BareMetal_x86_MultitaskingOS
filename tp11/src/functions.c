...
__attribute__(( section(".functions"))) __limpiarBuffer(dword *dst){
    //asm("xchg %bx,%bx");
    byte i;
    for (i = 0; (i < 0x10) ; i++){
        *dst = 0x0;
...
__attribute__(( section(".functions")))  __set_dir_page_table_entry(dword init_dpt,
                                                                    dword entry,
                                                                    dword init_pt, 
                                                                    dword _ps,
                                                                    dword _a,
...
__attribute__(( section(".functions")))  __set_page_table_entry(dword init_pt,
                                                                dword entry,
                                                                dword init_p, 
                                                                dword _ps,
                                                                dword _a,
